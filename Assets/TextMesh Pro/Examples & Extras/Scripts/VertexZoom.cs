        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Konversi Vector4[] ke Vector2[] untuk operasi lebih lanjut
                    Vector2[] sourceUVs0 = System.Array.ConvertAll(sourceUVs0_4, item => new Vector2(item.x, item.y));
                    Vector2[] destinationUVs0 = System.Array.ConvertAll(destinationUVs0_4, item => new Vector2(item.x, item.y));
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // Konversi uvs0 (Vector4[]) ke Vector2[]
                    Vector4[] uvs0_4 = textInfo.meshInfo[i].uvs0;
                    Vector2[] uvs0_2 = System.Array.ConvertAll(uvs0_4, item => new Vector2(item.x, item.y));

                    // Update modified vertex attributes
                    textInfo.meshInfo[i].mesh.vertices = textInfo.meshInfo[i].vertices;
                    textInfo.meshInfo[i].mesh.uv = uvs0_2; // Gunakan uvs0 hasil konversi
